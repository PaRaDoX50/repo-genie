...
from assistant.file_watcher import start_file_watcher
...
from assistant.llama_cpp_assistant import LlamaCppAssistant
from assistant.llama_cpp_embed import LlamaCppEmbed
...
The user is currently working in the following directory (CWD): {os.getcwd()}"""
    ...
    print("llm_model_file", llm_model_file)
    print("embed_model_file", embed_model_file)
    # LiteLLM settings
    ...
    print("lite_llm_context_size", lite_llm_context_size)
    # Assistant settings
